#!/usr/bin/env node
const base = {
  arbeitsverhaeltnis: '3', bundesland: '0', alleinverdienerabsetzbetrag: '0',
...
for (const gross of [3000, 3400, 3500, 3600, 4000]) {
  const d = await fetchGross(gross);
  console.log(gross, 'rec LS', d['Lohnsteuer']?.[0], '13 LS', d['Lohnsteuer']?.[1]);
}
