...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    'de': {
      ...
      'proLoginHint': 'Hast du bereits Pro, melde dich mit deinem Konto an.',
      'disclaimerTitle': 'Haftungsausschluss',
      'disclaimerText': 'Keine Steuerberatung. Informativer Schätzwert.',
      'attemptsExhaustedTitle': 'Gratis-Berechnungen aufgebraucht',
      'attemptsExhaustedBody': 'Deine kostenlosen Berechnungen sind verbraucht. Sie stehen in 24 Stunden wieder zur Verfügung. Hast du bereits Pro, melde dich mit deinem Konto an.',
      'compareTitle': 'Gratis oder Pro',
      'compareSubtitle': 'Das schaltest du mit Pro frei.',
      'compareFeatureCol': 'Funktion',
      'compareFreeCol': 'Gratis',
      'compareProCol': 'Pro',
      ...
      'compareComingSoon': 'Demnächst',
      'comparePriceLine': 'Ab 3,99 €/Monat · jederzeit kündbar',
      'compareChoosePlan': 'Tarif wählen',
      'compareHaveAccount': 'Schon ein Konto? Anmelden',
      ...
      'authResetPasswordSuccess': 'Dein Passwort wurde geändert.',
      ...
      'bankingPageSubtitle':
          'Verbinde dein österreichisches Bankkonto, um Transaktionen zu sehen (nur Lesezugriff).',
    ...
    'en': {
      ...
      'proLoginHint': 'If you already have Pro, log in with your account.',
      'disclaimerTitle': 'Disclaimer',
      'disclaimerText': 'Not tax advice. Informational estimate only.',
      'attemptsExhaustedTitle': 'Free calculations used up',
      'attemptsExhaustedBody': 'You have used your free calculations. They come back in 24 hours. If you already have Pro, log in with your account.',
      ...
      'compareComingSoon': 'Coming soon',
      'comparePriceLine': 'From €3.99/month · cancel anytime',
      'compareChoosePlan': 'Choose my plan',
      'compareHaveAccount': 'Already have an account? Log in',
      ...
      'authResetPasswordSuccess': 'Your password has been changed.',
      ...
      'bankingPageSubtitle':
          'Connect your Austrian bank account to see your transactions (read-only).',
    ...
    'tr': {
      ...
      'proLoginHint': "Zaten Pro'n varsa hesabınla giriş yap.",
      'disclaimerTitle': 'Sorumluluk reddi',
      'disclaimerText': 'Vergi danışmanlığı değildir. Bilgilendirme amaçlı tahmini değerdir.',
      'attemptsExhaustedTitle': 'Ücretsiz hesaplamalar bitti',
      'attemptsExhaustedBody': "Ücretsiz hesaplamalarını kullandın. 24 saat içinde yenilenir. Zaten Pro'n varsa hesabınla giriş yap.",
      'compareTitle': 'Ücretsiz ve Pro',
      'compareSubtitle': 'Pro ile şunların kilidini açarsın.',
      'compareFeatureCol': 'Özellik',
      'compareFreeCol': 'Ücretsiz',
      'compareProCol': 'Pro',
      ...
      'compareComingSoon': 'Yakında',
      'comparePriceLine': "Aylık 3,99 €'dan başlayan fiyatlarla · istediğin zaman iptal",
      'compareChoosePlan': 'Planımı seç',
      'compareHaveAccount': 'Zaten hesabın var mı? Giriş yap',
      ...
      'authResetPasswordSuccess': 'Şifren değiştirildi.',
      ...
      'bankingPageSubtitle':
          'İşlemlerini görmek için Avusturya banka hesabını bağla (yalnızca görüntüleme).',
    ...
    'bcs': {
      ...
      'proLoginHint': 'Ako već imaš Pro, prijavi se svojim računom.',
      'disclaimerTitle': 'Odricanje od odgovornosti',
      'disclaimerText': 'Nije poresko savjetovanje. Informativna procjena.',
      'attemptsExhaustedTitle': 'Besplatni obračuni iskorišteni',
      'attemptsExhaustedBody': 'Iskoristio si besplatne obračune. Vraćaju se za 24 sata. Ako već imaš Pro, prijavi se svojim računom.',
      'compareTitle': 'Besplatno i Pro',
      'compareSubtitle': 'Ovo otključavaš uz Pro.',
      'compareFeatureCol': 'Funkcija',
      'compareFreeCol': 'Besplatno',
      'compareProCol': 'Pro',
      ...
      'compareComingSoon': 'Uskoro',
      'comparePriceLine': 'Od 3,99 €/mjesečno · otkaži kad želiš',
      'compareChoosePlan': 'Odaberi moj plan',
      'compareHaveAccount': 'Već imaš račun? Prijavi se',
      ...
      'authResetPasswordSuccess': 'Tvoja lozinka je promijenjena.',
      ...
      'bankingPageSubtitle':
          'Poveži svoj austrijski bankovni račun da vidiš svoje transakcije (samo za čitanje).',
    ...
    'es': {
      ...
      'proLoginHint': 'Si ya tienes Pro, inicia sesión con tu cuenta.',
      'disclaimerTitle': 'Aviso legal',
      'disclaimerText': 'No es asesoría fiscal. Estimación informativa.',
      'attemptsExhaustedTitle': 'Cálculos gratis agotados',
      'attemptsExhaustedBody': 'Has usado tus cálculos gratuitos. Se restauran en 24 horas. Si ya tienes Pro, inicia sesión con tu cuenta.',
      ...
      'compareComingSoon': 'Próximamente',
      'comparePriceLine': 'Desde 3,99 €/mes · cancela cuando quieras',
      'compareChoosePlan': 'Elegir mi plan',
      'compareHaveAccount': '¿Ya tienes cuenta? Inicia sesión',
      ...
      'authResetPasswordSuccess': 'Tu contraseña fue cambiada.',
      ...
      'bankingPageSubtitle':
          'Conecta tu cuenta bancaria austríaca para ver tus transacciones (solo lectura).',
    ...
    'uk': {
      ...
      'proLoginHint': 'Якщо в тебе вже є Pro, увійди у свій акаунт.',
      'disclaimerTitle': 'Застереження',
      'disclaimerText': 'Це не податкова консультація. Орієнтовна оцінка.',
      'attemptsExhaustedTitle': 'Безкоштовні розрахунки вичерпано',
      'attemptsExhaustedBody': 'Ти використав безкоштовні розрахунки. Вони відновляться за 24 години. Якщо в тебе вже є Pro, увійди у свій акаунт.',
      'compareTitle': 'Безкоштовно та Pro',
      'compareSubtitle': 'Ось що відкриває Pro.',
      'compareFeatureCol': 'Функція',
      'compareFreeCol': 'Безкоштовно',
      'compareProCol': 'Pro',
      ...
      'compareComingSoon': 'Незабаром',
      'comparePriceLine': 'Від 3,99 €/міс · скасуй будь-коли',
      'compareChoosePlan': 'Обрати мій план',
      'compareHaveAccount': 'Уже маєш акаунт? Увійти',
      ...
      'authResetPasswordSuccess': 'Ваш пароль змінено.',
      ...
      'bankingPageSubtitle':
          'Підключіть свій австрійський банківський рахунок, щоб бачити транзакції (лише перегляд).',
